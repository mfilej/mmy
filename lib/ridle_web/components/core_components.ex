defmodule RidleWeb.CoreComponents do
  @moduledoc """
  ...
  def error(assigns) do
    ~H"""
    <p class="sr-only mt-3 flex gap-3 text-sm leading-6 text-rose-600">
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(Ridle.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(Ridle.Gettext, "errors", msg, opts)
    # end
