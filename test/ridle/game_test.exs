defmodule Ridle.GameTest do
  ...
  describe "offer_guess/2" do
    test "random guess, guesses nothing correctly" do
      ...
      {:ok, outcome} =
        Game.offer_guess(round, %{"make" => "asdf", "model" => "asdf", "year" => 1919})
    ...
    test "guesses the make" do
      ...
      {:ok, outcome} =
        Game.offer_guess(round, %{"make" => "BMW", "model" => "M5", "year" => 1990})
    ...
    test "guesses everything correctly" do
      ...
      {:ok, outcome} =
        Game.offer_guess(round, %{"make" => "Citroen", "model" => "DS", "year" => 1970})
    ...
    test "guess does not pass validations" do
      ...
      assert {:error, %Ecto.Changeset{valid?: false} = changeset} =
               Game.offer_guess(round, %{"make" => "", "model" => "", "year" => 500})
